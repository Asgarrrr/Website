...
<template>
  <transition name="fade">
    ...
    >
      <div
        class="rounded-md bg-gray-200 h-40 w-1 hidden relative md:block dark:bg-neutral-800"
      >
        <div
          class="rounded-md inset-x-0 transition bottom-0 absolute left-0 right-0"
          :class="{
