exports.ids = [72,0,21,26,62,63,64,65,66];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/donate.vue?vue&type=template&id=4a209611&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _c('PageLayout', {
  ...
  }, [_c('Title', [_vm._v("Support Me On")]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("Sponsors")]), _vm._v(" "), _c('div', [_c('transition', {
    attrs: {
      "name": "fade",
      "mode": "out-in"
    }
  ...
  })], 2)], 1)], 1)], 1), _vm._v(" "), _c('section', {
    staticClass: "space-y-4"
  }, [_c('Title', [_vm._v("Bank Accounts")]), _vm._v(" "), _c('div', {
    staticClass: "grid gap-4"
  }, _vm._l(_vm.accounts, function (account, index) {
    return _c('div', {
      key: `account-${index}`,
      staticClass: "flex h-full space-x-4 items-center rounded-lg card-base"
    }, [_c('div', {
      staticClass: "rounded-lg"
    }, [_c('SmartImage', {
      staticClass: "rounded-lg h-12 w-12",
      attrs: {
        "src": account.image
      }
    })], 1), _vm._v(" "), _c('div', {
      staticClass: "rounded-tr rounded-br flex h-full"
    }, [_c('div', [_c('h3', {
      staticClass: "font-medium text-lg"
    }, [_vm._v("\n              " + _vm._s(account.name) + "\n            ")]), _vm._v(" "), _c('span', {
      staticClass: "text-black/30 dark:text-white/30",
    ...
    }, [_vm._v("\n              " + _vm._s(account.revealed ? account.iban : "Click to Reveal") + "\n            ")])])])]);
  }), 0)], 1)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./src/pages/donate.vue?vue&type=template&id=4a209611&
...
/* harmony default export */ var donatevue_type_script_lang_ts_ = (external_vue_default.a.extend({
  ...
  async fetch() {
    const {
      data
    } = await this.$axios.get("https://raw.githubusercontent.com/Asgarrrr/.github/main/sponsors.json");
    this.sponsors = data;
  },
  head() {
    const title = "Donate";
...
/* nuxt-component-imports */
installComponents(component, {Title: __webpack_require__(28).default,IconBrand: __webpack_require__(70).default,Button: __webpack_require__(7).default,SkeletonLoader: __webpack_require__(64).default,CardSponsor: __webpack_require__(108).default,SmartImage: __webpack_require__(27).default,PageLayout: __webpack_require__(71).default})
